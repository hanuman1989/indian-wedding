...
function getApiFieldErrors(error) {
  ...
  const fields = {
    ...
    fathersName: apiErrors.fathers_name,
    mothersName: apiErrors.mothers_name,
    ...
    'bride.fathersName': apiErrors['bride.fathers_name'],
    'bride.mothersName': apiErrors['bride.mothers_name'],
    ...
    'groom.fathersName': apiErrors['groom.fathers_name'],
    'groom.mothersName': apiErrors['groom.mothers_name'],
