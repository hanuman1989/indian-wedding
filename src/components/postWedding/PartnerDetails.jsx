    ...
    <section className="border border-gold-200 bg-white/65 p-5 sm:p-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <FormField htmlFor={`${partner}-first-name`} label="First Name" error={errors[`${partner}.firstName`]} required>
          <InputWithIcon id={`${partner}-first-name`} Icon={Users} value={values.firstName} onChange={(event) => onChange(`${partner}.firstName`, event.target.value)} onBlur={() => onBlur(`${partner}.firstName`)} autoComplete="given-name" error={errors[`${partner}.firstName`]} placeholder="Enter first name" />
        </FormField>
        <FormField htmlFor={`${partner}-last-name`} label="Last Name" error={errors[`${partner}.lastName`]} required>
          <InputWithIcon id={`${partner}-last-name`} Icon={Users} value={values.lastName} onChange={(event) => onChange(`${partner}.lastName`, event.target.value)} onBlur={() => onBlur(`${partner}.lastName`)} autoComplete="family-name" error={errors[`${partner}.lastName`]} placeholder="Enter last name" />
        </FormField>
      </div>
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        <FormField htmlFor={`${partner}-email`} label="Email Address" error={errors[`${partner}.email`]} required>
          <InputWithIcon id={`${partner}-email`} Icon={Mail} type="email" value={values.email} onChange={(event) => onChange(`${partner}.email`, event.target.value)} onBlur={() => onBlur(`${partner}.email`)} autoComplete="email" error={errors[`${partner}.email`]} placeholder="Enter email address" />
        </FormField>
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        <FormField htmlFor={`${partner}-fathers-name`} label="Father's Name" error={errors[`${partner}.fathersName`]} required>
          <InputWithIcon id={`${partner}-fathers-name`} Icon={Users} value={values.fathersName} onChange={(event) => onChange(`${partner}.fathersName`, event.target.value)} onBlur={() => onBlur(`${partner}.fathersName`)} autoComplete="name" error={errors[`${partner}.fathersName`]} placeholder="Enter father's name" />
        </FormField>
        <FormField htmlFor={`${partner}-mothers-name`} label="Mother's Name" error={errors[`${partner}.mothersName`]} required>
          <InputWithIcon id={`${partner}-mothers-name`} Icon={Users} value={values.mothersName} onChange={(event) => onChange(`${partner}.mothersName`, event.target.value)} onBlur={() => onBlur(`${partner}.mothersName`)} autoComplete="name" error={errors[`${partner}.mothersName`]} placeholder="Enter mother's name" />
        </FormField>
      </div>
    </section>
  );
  ...
  return (
    <div>
      ...
      <div className="mt-6 space-y-5">
        {showBride && <PartnerContactSection partner="bride" title="Bride's Details" values={form.bride} errors={errors} onChange={onChange} onBlur={onBlur} />}
        {showGroom && <PartnerContactSection partner="groom" title="Groom's Details" values={form.groom} errors={errors} onChange={onChange} onBlur={onBlur} />}
      </div>
    </div>
  );
}