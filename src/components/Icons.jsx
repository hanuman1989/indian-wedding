...
export const Share = (p) => (
  <S {...p}>
    ...
    <path d="m8.1 10.7 7.7-4.3M8.1 13.3l7.7 4.3" />
  </S>
)

export const Quote = (p) => (
  <F {...p}>
    <path d="M9.6 6.6c-3.2.7-5.2 3.2-5.2 6.7v5h6.3v-6.4H8c.1-1.8 1.1-3.1 2.7-3.7L9.6 6.6Zm8.4 0c-3.2.7-5.2 3.2-5.2 6.7v5h6.3v-6.4h-2.7c.1-1.8 1.1-3.1 2.7-3.7l-1.1-1.6Z" />
  </F>
)
...
export const Leaf = (p) => (
  <S {...p}>
    ...
    <path d="M6.5 17.5c3-4 6-7 10.5-10" />
  </S>
)

export const MessageCircle = (p) => (
  <S {...p}>
    <path d="M12 3.6c-4.9 0-8.8 3.3-8.8 7.4 0 2.3 1.2 4.3 3.1 5.7-.2 1-.7 2.1-1.4 3 1.6-.2 3.1-.8 4.3-1.6.9.2 1.8.3 2.8.3 4.9 0 8.8-3.3 8.8-7.4s-3.9-7.4-8.8-7.4Z" />
  </S>
)

export const WineGlass = (p) => (
  <S {...p}>
    <path d="M6.6 3.6h10.8c0 4.7-2.3 7.8-5.4 8.2V18M12 11.8V18M8.6 20.4h6.8" />
    <path d="M6.6 3.6c0 2.6.8 4.6 2.1 5.9M17.4 3.6c0 2.6-.8 4.6-2.1 5.9" />
  </S>
)
